...
SELECT 
	AVG(INT_RATE) *100 AS MTD_AVERAGE_INTEREST_RATE 
FROM 
	financial_loan
WHERE 
	MONTH(ISSUE_DATE) = 12
...
SELECT 
	AVG(INT_RATE) *100 AS PMTD_AVERAGE_INTEREST_RATE 
FROM 
	financial_loan
WHERE 
	MONTH(ISSUE_DATE) = 11
...
SELECT 
	AVG(DTI) * 100 AS MTD_AVERAGE_DEBT_INCOME_RATIO 
FROM 
	financial_loan
WHERE 
	MONTH(ISSUE_DATE) = 12
...
SELECT 
	AVG(DTI)* 100 AS PMTD_AVERAGE_DEBT_INCOME_RATIO 
FROM 
	financial_loan
WHERE 
	MONTH(ISSUE_DATE) = 11
...
SELECT 
	SUM(LOAN_AMOUNT) AS GOOD_LOAN_FOUNDED_AMOUNT
FROM 
	financial_loan
WHERE 
	LOAN_STATUS = 'Fully Paid' OR LOAN_STATUS = 'Current'
...
SELECT 
	SUM(LOAN_AMOUNT) AS BAD_LOAN_FOUNDED_AMOUNT
FROM 
	financial_loan
WHERE 
	LOAN_STATUS = 'Charged Off'
